    ...
    if(errorMessage.equals("")){
        ...
        try{
            ...
            if("TRANSACTION".equals(
            	    ...
            	    reportFile =
            	        "RejectedTransactionReport_Transaction.jasper";
            	}
            	    ...
            	    reportFile =
            	        "RejectedTransactionReport_Application.jasper";
            	}

            	else{

            	    reportFile =
            	        "RejectedTransactionRepor_UserModification.jasper";
            	}
            ...
            if(
                ...
                response.setHeader(
                    "Content-Disposition",
                    "inline; filename=\"RejectedTransactionReport.pdf\""
                );
            ...
            ============================================== */
                ...
                response.setHeader(
                    "Content-Disposition",
                    "attachment; filename=\"RejectedTransactionReport.xls\""
                );
...
<title>
Rejected Transaction / Application Report
</title>
...
<form method="post"
action="<%=request.getContextPath()%>/Reports/jspFiles/RejectedTransactionReport.jsp"
target="_blank"
autocomplete="off">
