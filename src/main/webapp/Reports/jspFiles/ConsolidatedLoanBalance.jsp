    ...
    try{
        ...
        String jasperPath =
            application.getRealPath(
                "/Reports/ConsolidatedLoanBalance.jasper"
            );
        ...
        parameters.put("report_title","BRANCH WISE STATEMENT OF LOAN BALANCE");
        ...
        if("pdf".equalsIgnoreCase(reporttype)){
            ...
            response.setHeader(
                "Content-Disposition",
                "inline; filename=\"ConsolidatedLoanBalance.pdf\""
            );
        ...
        ================================================= */
            ...
            response.setHeader(
                "Content-Disposition",
                "attachment; filename=\"ConsolidatedLoanBalance.xls\""
            );
...
<title>Consolidated Loan Balance</title>
...
BRANCH WISE STATEMENT OF LOAN BALANCE
</h1>

<form method="post"
action="<%=request.getContextPath()%>/Reports/jspFiles/ConsolidatedLoanBalance.jsp"
target="_blank"
autocomplete="off">
