...
if("download".equals(action)){
    ...
    String reportMode =
        request.getParameter("report_mode");
    ...
    try{
        ...
        if("SUMMARY".equalsIgnoreCase(reportMode)){
            ...
            jasperName =
                "/Reports/FreezeAccountRG_summary.jasper";

        }else{

            jasperName =
                "/Reports/FreezeAccountRG_details.jasper";
        }
        ...
        Map<String,Object> parameters =
        	...
        	parameters.put(
        	    ...
        	    "SUMMARY".equalsIgnoreCase(reportMode)

        	    ?

        	    "FREEZE ACCOUNT SUMMARY REPORT"

        	    :

        	    "FREEZE ACCOUNT REPORT"
        	);

        	/* =========================================
        	   SUMMARY REASON PARAMETER
        	========================================= */

        	if("SUMMARY".equalsIgnoreCase(reportMode)){

        	    String year =
        	        asOnDate.substring(8);
        ...
        if("pdf".equalsIgnoreCase(reporttype)){
            ...
            response.setHeader(
                "Content-Disposition",
                "inline; filename=\"FreezeAccountReport.pdf\""
            );
        ...
        ================================================= */
            ...
            response.setHeader(
                "Content-Disposition",
                "attachment; filename=\"FreezeAccountReport.xls\""
            );
...
<title>Freeze Account Report</title>
...
<form method="post"
action="<%=request.getContextPath()%>/Reports/jspFiles/FreezeAccountRG.jsp"
target="_blank"
autocomplete="off">
