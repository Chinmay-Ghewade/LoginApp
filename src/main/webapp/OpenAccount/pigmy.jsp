...
<div>
    ...
    <div class="nominee-card joint-block">
     <button type="button" class="nominee-remove" onclick="removeJointHolder(this)">✖</button>
      ...
      <div class="address-grid">
       ...
       <div>
          <label>State</label>
          <select name="jointState[]" id="dd-jointCountry" required class="dd-loading">
  		<option value="">Loading...</option>
		</select>
        </div>
  ...
  <div class="form-buttons">
    <button type="submit" onclick="LoadingOverlay.show('Saving Pigmy Application', 'Please wait')">Save</button>
