...
<form action="SaveFAApplicationServlet" method="post" onsubmit="return validateForm()">
  ...
  <div class="form-buttons">
    <button type="submit" onclick="LoadingOverlay.show('Saving Fixed Asset Application', 'Please wait')">Save</button>
...
jEventListener('DOMContentLoaded', function () {
    PopupMsg.fromUrlParams(
        'Fixed Asset Application Saved',
